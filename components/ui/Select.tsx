  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ref={ref}
        id={selectId}
        className={`rounded-xl border px-3 py-2 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
          error
