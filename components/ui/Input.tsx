  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ref={ref}
        id={inputId}
        className={`rounded-lg border px-3 py-2 text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-colors ${
          error
