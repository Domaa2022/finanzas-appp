    ...
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs text-gray-500 dark:text-slate-400">Ingresos del mes</span>
        </div>
        <p className="text-lg font-bold text-gray-900 dark:text-slate-100">{formatHNL(ingresosMes)}</p>
      </div>

      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5">
        <div className="flex items-center gap-2 mb-1">
          <TrendingDown className="h-4 w-4 text-red-500" />
          <span className="text-xs text-gray-500 dark:text-slate-400">Gastos del mes</span>
        </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs text-gray-500 dark:text-slate-400">Ahorrado el mes</span>
        </div>
