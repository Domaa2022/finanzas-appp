  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-5 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-base font-semibold text-gray-900 dark:text-slate-100">Resumen del mes</h2>
        <span className="text-xs text-gray-400 dark:text-slate-500">Sobrante disponible</span>
      </div>
      ...
      <div className="grid grid-cols-4 gap-2 sm:gap-3">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <p className={`font-bold text-sm sm:text-base ${sobranteMes > 0 ? 'text-violet-600' : 'text-gray-400 dark:text-slate-500'}`}>
